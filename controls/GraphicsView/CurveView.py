...
from controls.GraphicsView.TimelineViewCommon import *
...
class CurveView(GLGraphicsView):
    ...
    def notifyVertChanged(self, vert, posChanged=True, bezierPointChanged=True):
        ...
        if bezierPointChanged:
            ...
            self.vertBezierPointChanged.emit(vert.node, preBPX, preBPY / _PIXEL_PER_UNIT, postBPX,
                                             postBPY / _PIXEL_PER_UNIT)
