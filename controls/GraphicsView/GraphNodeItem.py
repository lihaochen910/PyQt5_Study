# -*- coding: utf-8 -*-
from controls.GraphicsView.GraphNodeItemBase import *
...
##----------------------------------------------------------------##
class GraphNodeGroupItem(QtWidgets.QGraphicsRectItem, GraphNodeItemBase):
...
class GraphNodePortItem(QtWidgets.QGraphicsRectItem, GraphNodeItemBase):
...
##----------------------------------------------------------------##
class GraphNodeHeaderItem(QtWidgets.QGraphicsRectItem, GraphNodeItemBase):
    _pen = Qt.NoPen
